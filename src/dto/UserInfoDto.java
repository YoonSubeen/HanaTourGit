...
public class UserInfoDto {
	...
	public UserInfoDto(
			...
			String gender, String birth, String phone, String email,
			String lastName, String firstName, String passportNumber,
			String passportExpirationDate, String nationality, String authority) {
		super();
		this.id = id;
		this.pw = pw;
		this.name = name;
