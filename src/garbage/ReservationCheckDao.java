...
// 	TravelReservationCheckDto 리턴 userID 받기	
	public ArrayList<TravelReservationCheckDto> travelReservationCheck(String userId) throws Exception {
...
// 해외여행 취소 내역 
	public ArrayList<TravelCancelCheckDto> travelCancelCheck(String userId) throws Exception {
...
// 호텔 예약내역
	public ArrayList<HotelReservationCheckDto> hotelReservationCheck(String user_id) throws Exception {
...
// 호텔 취소 내역	
	public ArrayList<HotelCancelCheckDto> hotelCancelCheck(String userId) throws Exception {
...
// user_id를 파라미터로 받아서 출력
	public ArrayList<OverseaFlightReservationCheckDto> overseaFlightReservationCheck(String userId) throws Exception {
...
// 해외항공 취소 
	public ArrayList<OverseaFlightCancelCheckDto> overseaFlightCancelCheck(String userId) throws Exception {
...
// 국내항공 예약
// user_id를 파라미터로 받아서 출력
	public ArrayList<DomesticFlightReservationCheckDto> domesticFlightReservationCheck(String userId) throws Exception {
...
// 국내항공 취소 
	public ArrayList<DomesticFlightCancelCheckDto> domesticFlightCancelCheck(String userId) throws Exception {
...
// 투어예약 내역	
	public ArrayList<ShowTourReservationDto> showTourReservation(String userId) throws Exception {
