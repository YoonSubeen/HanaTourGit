...
@WebServlet("/AirlinePaymentServlet")
public class AirlinePaymentServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 결제 성공시 redirect url
		jObj.put("approval_url", "http://localhost:8081/HanaTourGit/hanatour/jsp/main5_airline/main5_airline_payment_success.jsp");
		// 결제 취소시 redirect url
		jObj.put("fail_url", "http://localhost:8081/HanaTourGit/hanatour/jsp/main5_airline/main5_airline_payment_fail.jsp");  
		// 결제 실패시 redirect url
		jObj.put("cancel_url", "http://localhost:8081/HanaTourGit/hanatour/jsp/main5_airline/main5_airline_payment_cancel.jsp");  
