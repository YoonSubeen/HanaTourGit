...
@WebServlet("/AirlineRoundtrip4ReservationServlet")
public class AirlineRoundtrip4ReservationServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("hanatour/jsp/main5_airline/main5_round_trip4_reservation.jsp").forward(request, response);
