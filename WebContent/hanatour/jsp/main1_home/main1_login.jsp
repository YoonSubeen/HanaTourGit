...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath() %>/hanatour/css/main1_login.css">
</head>
<body>
    ...
    <div class="main1_login_form">
        <div class="main1_login_form_inner">
            ...
            <div class="main1_login_form2">
                <div>
                    <img src="<%=request.getContextPath() %>/hanatour/img/main1_login/img_logo_hana_660x148.png" alt="">
                </div>
            </div>
            ...
            <div class="main1_login_form4">
                ...
                <div class="main1_login_form4_right">
                    <div>
                        <a href="<%=request.getContextPath() %>/hanatour/jsp/main1_home/main1_find_id.jsp">아이디 찾기</a>
                    </div>
                    <div>|</div>
                    <div> 
                        <a href="<%=request.getContextPath() %>/hanatour/jsp/main1_home/main1_find_pw.jsp">비밀번호 찾기</a>
                    </div>
                </div>
            </div>
...
<script src="<%=request.getContextPath() %>/hanatour/script_jsp/main1_login.js"></script>
</html>