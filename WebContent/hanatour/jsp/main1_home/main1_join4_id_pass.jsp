...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath() %>/hanatour/css/main1_join4_id_pass.css">
</head>
<body>
        ...
        <div class="main1_join4_inner">
            ...
            <div class="main1_join4_inner4">
                ...
                <form action="<%=request.getContextPath() %>/Join4IdDuplicateCheckServlet" class="main1_join4_form1">
                    ...
                    ">
                        <div>
                            <input type="text" name="join_id" placeholder="아이디" value="<%= (String)session.getAttribute("join_id") %>"/>
                        </div>
...
<script src="<%=request.getContextPath() %>/hanatour/script_jsp/main1_join4_id_pass.js"></script>
</html>