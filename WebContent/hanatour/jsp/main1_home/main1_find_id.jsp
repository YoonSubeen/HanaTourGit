...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath() %>/hanatour/css/main1_find_id.css">
</head>
<body>
...
<script src="<%=request.getContextPath() %>/hanatour/script_jsp/main1_find_id.js"></script>
</html>