...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath() %>/hanatour/css/main1_join2.css">
</head>
<body>
...
<script src="<%=request.getContextPath() %>/hanatour/script_jsp/main1_join2.js"></script>
</html>