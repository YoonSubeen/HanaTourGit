...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath() %>/hanatour/css/main5_round_trip2.css">
</head>
<body>
                        ...
                        <div class="airline_ticket">
                            ...
                            <div class="airline_ticket_inner">
                                ...
                                <div class="airline_ticket1">
                                    <div class="airline_ticket_airline">
                                        <div>
                                            <img src="<%=request.getContextPath()%>/hanatour/img/main5_airline2/ailrine_logo2.png" alt="">
                                        </div>
                                        <div>아시아나항공</div>
                                    </div>
                                    <div class="airline_ticket_flight_number">
	...
	<form action="${pageContext.request.contextPath}/AirlineRoundtrip3Servlet" class="round_trip_select1">
...
<script src="<%=request.getContextPath() %>/hanatour/script_jsp/main5_round_trip2.js"></script>
