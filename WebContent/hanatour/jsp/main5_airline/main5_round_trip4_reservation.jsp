...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath() %>/hanatour/css/main5_round_trip4_reservation.css">
</head>
<body>
        ...
        <div class="airline_reservation_body_inner">
            ...
            <div class="airline_reservation_body_left">
                ...
                <div class="airline_reservation_agreements">
                    <form action="${pageContext.request.contextPath}/AirlineRoundtrip5Reservation2Servlet">
...
<script src="${pageContext.request.contextPath}/hanatour/script_jsp/main5_round_trip4_reservation.js"></script>
<script src="${pageContext.request.contextPath}/hanatour/script_jspt/footer.js"></script>
</html>