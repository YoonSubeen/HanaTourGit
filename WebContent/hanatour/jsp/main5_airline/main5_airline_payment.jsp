...
<body>
	...
	<form action="${pageContext.request.contextPath}/AirlinePaymentServlet" method="post">
	    <div id="payment_background-color">
			<div id="payment_page" class="center">
				...
				<div id="payment_method">
					...
					<div>
						<div>
							<input type="radio" id="kakao" value="kakao" name="payment_method" checked/>
...
<script src="${pageContext.request.contextPath}/hanatour/script_jsp/main5_airline_payment.js"></script>
